...
| 🎙️ **[Teach It To Grandma (Ongoing)](https://github.com/PavinSP/titanom-hackathon)** | Voice app that tests genuine understanding via the Feynman technique: explain a topic to an AI "Grandma" persona, graded by Claude on whether you actually explained it, not just said the keywords. | `ElevenLabs`, `React`, `Claude API` |
